...
mix castle.rollup.weekly [--lock,--date [yyyymmdd],--count [int]]
mix castle.rollup.monthly [--lock,--date [YYYYMMDD],--count [INT]]
mix castle.rollup.last_week [--lock,--date [YYYYMMDD],--count [INT]]
mix castle.rollup.last_month [--lock,--date [YYYYMMDD],--count [INT]]
```
