defmodule Castle.BigQueryBaseTimestampTest do
  ...
  @hour %{rollup: BigQuery.TimestampRollups.Hourly}
  @weekly %{rollup: BigQuery.TimestampRollups.Weekly}

  test "groups by a param" do
    sql = timestamp_sql("the_table", @hour, "feeder_podcast")
  ...
  test "sets params" do
    start = get_dtim("2017-03-22T21:00:00Z")
    finish = get_dtim("2017-03-28T04:00:00Z")
    ...
    assert_time params.from_dtim, "2017-03-22T21:00:00Z"
    assert_time params.to_dtim, "2017-03-28T04:00:00Z"
  ...
  test "groups results" do
    ...
    interval = %BigQuery.Interval{
      ...
      to: finish,
      rollup: BigQuery.TimestampRollups.Hourly,
      bucket: BigQuery.TimestampRollups.Hourly,
    }
    raw = [
