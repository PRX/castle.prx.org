defmodule Castle.BigQueryTimestampRollupsWeeklyTest do
  use Castle.BigQueryCase, async: true

  import BigQuery.TimestampRollups.Weekly
  ...
  test "range" do
    ...
    range = format_range("2017-03-12T00:00:00Z", "2017-03-26T00:00:00Z")
