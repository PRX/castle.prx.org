  ...
  defp podcast_json(podcast, conn) do
    %{
      ...
      _links: %{
        ...
        "prx:downloads": %{
          href: api_podcast_download_path(conn, :index, podcast.feeder_podcast) <> "{?interval,timeframe}",
          templated: true,
        },
        "prx:impressions": %{
          href: api_podcast_impression_path(conn, :index, podcast.feeder_podcast) <> "{?interval,timeframe}",
          templated: true,
        },
      }
    }
